...
import { OrderServicesServiceProxy, OrderDetailsDto, OrderProductDto } from '@shared/service-proxies/service-proxies';
...
totalproducts: number
  ...
  calculateTotals() {
    this.subtotal = this.orderDetails.orderProducts.reduce((acc, item) => acc + item.productPrice * item.quantity, 0);    
