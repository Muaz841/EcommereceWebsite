...
import { OrderServicesServiceProxy, OrderListDto, OrderCountDto,OrderListDtoPagedResultDto, PagedOrderResultRequestDto  } from '@shared/service-proxies/service-proxies';
  ...
  onsearch() {
   ...
   protected viewOrderDetails(entity: OrderListDto): void {
      ...
      ShowOrderStatuModal(entity: OrderListDto): void {
        ...
        editStatusModal = this._modalService.show(orderStatusModalComponent, { initialState });
      }
